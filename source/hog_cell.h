...
inline HogCell::HogCell() :
  bins_(NULL),
  num_bins_(0) { static const float kNoiseFloor = 1e-8;}

inline HogCell::HogCell(int num_bins, float *bin_data) :
  bins_(bin_data),
  num_bins_(num_bins) {static const float kNoiseFloor = 1e-8;}

inline HogCell::HogCell(const HogCell &rhs) :
  bins_(rhs.bins_),
  num_bins_(rhs.num_bins_) {static const float kNoiseFloor = 1e-8;}
